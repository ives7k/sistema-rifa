  ...
  return (
    <div className="bg-white p-2 rounded-lg shadow-md">
      ...
      <div className="flex items-center space-x-2">
          <div className="flex-grow bg-gray-100 rounded-lg p-1 flex justify-between items-center">
              <button onClick={resetQuantity} className="text-gray-500 hover:text-black text-lg px-2 rounded-full">
                <i className="bi bi-x-circle"></i>
              </button>
              <button onClick={() => handleAddQuantity(-1)} className="text-gray-500 hover:text-black text-xl px-2">
                <i className="bi bi-dash-circle"></i>
              </button>
              <input type="text" value={quantity} readOnly className="bg-transparent text-black text-center w-12 font-bold"/>
              <button onClick={() => handleAddQuantity(1)} className="text-green-500 hover:text-green-400 text-xl px-2">
                 <i className="bi bi-plus-circle-fill"></i>
              </button>
          </div>
          <button className="bg-[#28a745] hover:bg-green-700 text-white font-bold p-2 rounded-lg flex-1 flex items-center justify-center space-x-2">
