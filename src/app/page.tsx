  ...
  return (
    <div className="bg-[#ebebeb]"> 
      ...
      <div className="container mx-auto max-w-lg px-4 mt-2 space-y-2">
        <MyTicketsBar />
        <PurchaseSection ticketPrice={settings.ticketPrice} drawLabel={drawLabel} campaignTitle={settings.title} campaignImage={settings.imageUrl} minQuantity={settings.minQuantity} defaultQuantity={settings.defaultQuantity} />
        <Regulation />
        <Prizes />
      </div>
